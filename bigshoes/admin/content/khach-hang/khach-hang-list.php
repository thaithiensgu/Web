                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                            ...
                                            <?php if ($trang_thai == '0') { ?>
                                                <a onclick="return confirm('Bạn có chắc chắn muốn khóa tài khoản này ?')" href="khach-hang-khoa.php?ma_kh=<?= $ma_kh ?>"><button class="btn btn-success">Khóa</button></a>
                                            <?php } ?>
                                            <?php if ($trang_thai == '1') { ?>
                                                <a onclick="return confirm('Bạn có chắc chắn muốn mở khóa tài khoản này ?')" href="khach-hang-go-khoa.php?ma_kh=<?= $ma_kh ?>"><button class="btn btn-warning">Mở khóa</button></a>
                                        <?php }
                                        } ?>
                                    </td>
                                </tr>
