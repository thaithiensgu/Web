            ...
            <div class="header">
                <div class="page-header">
                    ...
                    if (array_key_exists("btn_insert", $_REQUEST)) {
                        ...
                        hang_hoa_insert($ten_hh, $hinh, $hinh1, $hinh2, $hinh3, $don_gia, $giam_gia, $so_luong_sp, $mo_ta, $ma_loai);
                        unset($ten_hh, $hinh, $hinh1, $hinh2, $hinh3, $don_gia, $giam_gia, $so_luong_sp, $mo_ta, $ma_loai);
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="so_luong_sp" name="so_luong_sp" min="0" max="100" placeholder="Nhập số lượng sp">
                        </div>
