            ...
            <div class="header">
                <div class="page-header">
                    ...
                    if (array_key_exists("btn_update", $_REQUEST)) {
                        ...
                        hang_hoa_update($ma_hh, $ten_hh, $don_gia, $giam_gia, $so_luong_sp, $hinh, $hinh1, $hinh2, $hinh3, $ma_loai, $mo_ta);
                        $message = "Sửa thành công !";
                        echo "<script type='text/javascript'>alert('$message');
                        window.location.replace('hang-hoa-list.php');
                        </script>";
                    }
                    ?>
                    <!-- /. CONTENT  -->
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="so_luong_sp" name="so_luong_sp" min="0" max="100" placeholder="Nhập số lượng sp" value="<?= $so_luong_sp ?>">
                        </div>
