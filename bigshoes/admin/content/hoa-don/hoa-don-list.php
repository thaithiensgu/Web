                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="huy-don-admin.php?ma_hd=<?= $ma_hd ?>">
                                            <?php
                                            if ($huy_don == 1) {
                                                echo '<button class="btn btn-danger name="thanh_toan">';
                                                echo "Xác nhận hủy đơn";
                                            } elseif ($huy_don == 2) {
                                                echo '<button class="btn btn-primary name ="thanh_toan">';
                                                echo "Đã hủy đơn";
                                            }
                                    ...
                                    <td>
                                        <?php
                                        if ($tinh_trang == 0 && $huy_don != 2) {
                                        ?>
                                            <a onclick="return confirm('Bạn có chắc muốn hủy đơn hàng')" href="ly-do.php?ma_hd=<?= $ma_hd ?>&ma_kh=<?= $ma_kh ?>">
                                                <button type="submit" class="btn btn-warning" name="btn_delete">HỦY</button></a>
                                        <?php
                                        }
                                        ?>
                                    </td>
