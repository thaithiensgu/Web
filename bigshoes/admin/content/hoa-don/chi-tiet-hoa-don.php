                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?= $ten_hh ?></td>
                                    <td><?= $so_luong ?></td>
                                    <td><?= number_format($don_gia  - ($don_gia * $giam_gia) / 100) ?> VNĐ</td>
                                    <td><?= number_format(($don_gia - ($don_gia * $giam_gia) / 100) * $so_luong); ?> VNĐ</td>
                                </tr>
                            <?php } ?>
                            <tr>
                                <td colspan="3" style="text-align:center;"><b>TỔNG TIỀN</b></td>
                                <td><b><?= number_format(($don_gia - ($don_gia * $giam_gia) / 100) * $so_luong); ?> VNĐ</b></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
