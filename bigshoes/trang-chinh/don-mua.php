                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:300px">HỦY ĐƠN</th>
                                    <th>CHI TIẾT</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="huy-don-hang.php?ma_hd=<?= $value['ma_hd'] ?>">
                                            <?php
                                            if ($value['huy_don'] == 0) {
                                            ?>
                                                <button class="btn btn-warning text-white" name="thanh_toan" id="myBtn">Yêu cầu hủy đơn</button>
                                            <?php
                                            } else if ($value['huy_don'] == 1) {
                                                echo '<button class="btn btn-info text-white name ="thanh_toan">';
                                                echo "Chờ xác nhận";
                                            } else { ?>
                                                <button class="btn btn-danger text-white">Đã hủy đơn</button>
                                                <?php
                                                extract($value);
                                                $PHPtext = "Đơn hàng đã bị hủy 
                                                Người hủy đơn: $ma_ql 
                                                Lý do: $ly_do";
                                                ?>
                                                <?php
                                                ...
                                                <a href="" style="text-decoration: none">
                                                    <button class="btn btn-success text-whiter" name="thanh_toan" onclick="alert(JavaScriptAlert);">Thông tin</button>
                                                </a>
                                            <?php }
                                            ?>
                                            </button>
