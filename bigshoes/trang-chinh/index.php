...
<head>
    ...
    <link rel="stylesheet" href="../css/trang-chu/reponsive.css">
...
<body>
    ...
    <div class="container" style="margin-top: 50px;" id="caption">
        <div class="row">
            <div class="col-md-12">
                <div class="caption">
                    <p> 2021-2022 </p>
    ...
    <div class="container" style="margin-top: 100px;">
        <div class="row">
            <div class="col-md-12">
                <div class="caption">
                    <p>XEM NGAY NÀO !</p>
                    <h2> <span>SẢN PHẨM</span> ADIDAS</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 50px;" id="spbanchay">
        <div class="row">
            <div class="col-md-12">
                <div class="owl-carousel owl-theme ">
                    ...
                    ?>
                        <div class="item">
                            <a href="chi-tiet-sp.php?ma_hh=<?= $ma_hh ?>"><img id="banchay" style="width: 200px;height: 230px;" src="../../bigshoes/css/admin/images/products/<?= $hinh ?>" alt="ds"></a>
                        </div>
                    <?php } ?>
                </div>
            </div>
    ...
    <div class="container" style="margin-top: 100px;" id="saleoff">
        <div class="row">
            <div class="col-md-12">
                <div class="caption">
                    <p>XEM NGAY NÀO ... </p>
    ...
    <div class="container" style="margin-top: 50px;" id="spsaleoff">
        <?php
    ...
    <div class="container" style="margin-top: 100px;" id="trending">
        <div class="row">
            <div class="col-md-12">
                <div class="caption" id="captrending">
                    <p>XEM NGAY NÀO... </p>
                    <h2>SẢN PHẨM <span>PEGASUS</span>
                    </h2>
                </div>
            </div>
        </div>
    ...
    ?>
    <div class="container" style="margin-top: 30px" id="sptrending">
        <div class="row">
            <?php foreach ($items as $item) {
                extract($item);
            ?>
                <div class="col-md-3 col-sm-2" id="allsp">
                    <div class="card">
                        <a href="chi-tiet-sp.php?ma_hh=<?= $ma_hh ?>"><img style="height: 300px;" class="card-img-top" src="../../bigshoes/css/admin/images/products/<?= $hinh ?>" alt="Card image top"></a>
                        <div class="card-body">
        ...
        <div class="row">
            <div class="container" style="margin-top: 50px;">
                <div class="row" id="last">
                    <div class="col-md-3">
                        <div class="fo" id="fo">
                            <img id="img-last" src="../css/trang-chu/img/TBT.png" alt="" style="width:60px;">
                        </div>
                    </div>
